        ...
        <div className="grid grid-cols-1 md:grid-cols-2" style={{ minHeight: 'calc(100vh - 60px)' }}>
          ...
          <div className="border-b md:border-b-0 md:border-r border-white/10 px-8 md:px-16 py-20 md:py-28 flex flex-col justify-between">
            <div>
              ...
              <p style={{ color: '#AEADA9', fontSize: '15px', lineHeight: 1.75, fontWeight: 300, maxWidth: '360px', marginBottom: '3rem' }}>
                {c.intro}
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div>
                  ...
                  <a href="mailto:hola@wearebondy.com" style={{ color: '#F4F2EE', fontSize: '15px', fontWeight: 300, textDecoration: 'none' }}>hola@wearebondy.com</a>
                </div>
                <div>
                  ...
                  <a href="https://linkedin.com/company/bondygroup" target="_blank" rel="noopener noreferrer" style={{ color: 'rgba(255,255,255,0.5)', fontSize: '15px', fontWeight: 300, textDecoration: 'none' }}>/company/bondygroup ↗</a>
                </div>
              </div>
            </div>
            <div style={{ marginTop: '4rem', borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '2.5rem' }}>
              ...
              <p style={{ color: '#AEADA9', fontSize: '14px', fontWeight: 300, lineHeight: 1.72 }}>{c.joiningBody}</p>
            </div>
          </div>
          ...
          <div className="px-8 md:px-16 py-20 md:py-28">
            {status === 'success' ? (
              <div className="h-full flex flex-col justify-center">
                ...
                <p style={{ color: '#AEADA9', fontSize: '15px', fontWeight: 300, lineHeight: 1.75, maxWidth: '360px' }}>{c.success.body}</p>
              </div>
            ) : (
